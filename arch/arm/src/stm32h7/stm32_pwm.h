...
#ifdef CONFIG_STM32H7_TIM1_CH1OUT_1
#  define PWM_TIM1_CH1CFG GPIO_TIM1_CH1OUT_1
#else
...
#endif
#ifdef CONFIG_STM32H7_TIM1_CH2OUT_1
#  define PWM_TIM1_CH2CFG GPIO_TIM1_CH2OUT_1
#else
...
#endif
#ifdef CONFIG_STM32H7_TIM1_CH3OUT_1
#  define PWM_TIM1_CH3CFG GPIO_TIM1_CH3OUT_1
#else
...
#endif
#ifdef CONFIG_STM32H7_TIM1_CH4OUT_1
#  define PWM_TIM1_CH4CFG GPIO_TIM1_CH4OUT_1
#else
#  define PWM_TIM1_CH4CFG 0
#endif

#ifdef CONFIG_STM32H7_TIM2_CH1OUT_1
#  define PWM_TIM2_CH1CFG GPIO_TIM2_CH1OUT_1
#else
#  define PWM_TIM2_CH1CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM2_CH2OUT_1
#  define PWM_TIM2_CH2CFG GPIO_TIM2_CH2OUT_1
#else
#  define PWM_TIM2_CH2CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM2_CH3OUT_1
#  define PWM_TIM2_CH3CFG GPIO_TIM2_CH3OUT_1
#else
#  define PWM_TIM2_CH3CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM2_CH4OUT_1
#  define PWM_TIM2_CH4CFG GPIO_TIM2_CH4OUT_1
#else
#  define PWM_TIM2_CH4CFG 0
#endif

#ifdef CONFIG_STM32H7_TIM3_CH1OUT_1
#  define PWM_TIM3_CH1CFG GPIO_TIM3_CH1OUT_1
#else
#  define PWM_TIM3_CH1CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM3_CH2OUT_1
#  define PWM_TIM3_CH2CFG GPIO_TIM3_CH2OUT_1
#else
#  define PWM_TIM3_CH2CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM3_CH3OUT_1
#  define PWM_TIM3_CH3CFG GPIO_TIM3_CH3OUT_1
#else
#  define PWM_TIM3_CH3CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM3_CH4OUT_1
#  define PWM_TIM3_CH4CFG GPIO_TIM3_CH4OUT_1
#else
#  define PWM_TIM3_CH4CFG 0
#endif

#ifdef CONFIG_STM32H7_TIM4_CH1OUT_1
#  define PWM_TIM4_CH1CFG GPIO_TIM4_CH1OUT_1
#else
#  define PWM_TIM4_CH1CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM4_CH2OUT_1
#  define PWM_TIM4_CH2CFG GPIO_TIM4_CH2OUT_1
#else
#  define PWM_TIM4_CH2CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM4_CH3OUT_1
#  define PWM_TIM4_CH3CFG GPIO_TIM4_CH3OUT_1
#else
#  define PWM_TIM4_CH3CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM4_CH4OUT_1
#  define PWM_TIM4_CH4CFG GPIO_TIM4_CH4OUT_1
#else
#  define PWM_TIM4_CH4CFG 0
#endif

#ifdef CONFIG_STM32H7_TIM5_CH1OUT_1
#  define PWM_TIM5_CH1CFG GPIO_TIM5_CH1OUT_1
#else
#  define PWM_TIM5_CH1CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM5_CH2OUT_1
#  define PWM_TIM5_CH2CFG GPIO_TIM5_CH2OUT_1
#else
#  define PWM_TIM5_CH2CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM5_CH3OUT_1
#  define PWM_TIM5_CH3CFG GPIO_TIM5_CH3OUT_1
#else
#  define PWM_TIM5_CH3CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM5_CH4OUT_1
#  define PWM_TIM5_CH4CFG GPIO_TIM5_CH4OUT_1
#else
#  define PWM_TIM5_CH4CFG 0
#endif

#ifdef CONFIG_STM32H7_TIM8_CH1OUT_1
#  define PWM_TIM8_CH1CFG GPIO_TIM8_CH1OUT_1
#else
#  define PWM_TIM8_CH1CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM8_CH1NOUT_1
#  define PWM_TIM8_CH1NCFG GPIO_TIM8_CH1NOUT_1
#else
#  define PWM_TIM8_CH1NCFG 0
#endif
#ifdef CONFIG_STM32H7_TIM8_CH2OUT_1
#  define PWM_TIM8_CH2CFG GPIO_TIM8_CH2OUT_1
#else
#  define PWM_TIM8_CH2CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM8_CH2NOUT_1
#  define PWM_TIM8_CH2NCFG GPIO_TIM8_CH2NOUT_1
#else
#  define PWM_TIM8_CH2NCFG 0
#endif
#ifdef CONFIG_STM32H7_TIM8_CH3OUT_1
#  define PWM_TIM8_CH3CFG GPIO_TIM8_CH3OUT_1
#else
#  define PWM_TIM8_CH3CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM8_CH3NOUT_1
#  define PWM_TIM8_CH3NCFG GPIO_TIM8_CH3NOUT_1
#else
#  define PWM_TIM8_CH3NCFG 0
#endif
#ifdef CONFIG_STM32H7_TIM8_CH4OUT_1
#  define PWM_TIM8_CH4CFG GPIO_TIM8_CH4OUT_1
#else
#  define PWM_TIM8_CH4CFG 0
#endif

#ifdef CONFIG_STM32H7_TIM12_CH1OUT_1
#  define PWM_TIM12_CH1CFG GPIO_TIM12_CH1OUT_1
#else
#  define PWM_TIM12_CH1CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM12_CH2OUT_1
#  define PWM_TIM12_CH2CFG GPIO_TIM12_CH2OUT_1
#else
#  define PWM_TIM12_CH2CFG 0
#endif

#ifdef CONFIG_STM32H7_TIM13_CH1OUT_1
#  define PWM_TIM13_CH1CFG GPIO_TIM13_CH1OUT_1
#else
#  define PWM_TIM13_CH1CFG 0
#endif

#ifdef CONFIG_STM32H7_TIM14_CH1OUT_1
#  define PWM_TIM14_CH1CFG GPIO_TIM14_CH1OUT_1
#else
#  define PWM_TIM14_CH1CFG 0
#endif

#ifdef CONFIG_STM32H7_TIM15_CH1OUT_1
#  define PWM_TIM15_CH1CFG GPIO_TIM15_CH1OUT_1
#else
#  define PWM_TIM15_CH1CFG 0
#endif

#ifdef CONFIG_STM32H7_TIM15_CH1NOUT_1
#  define PWM_TIM15_CH1NCFG GPIO_TIM15_CH1NOUT_1
#else
#  define PWM_TIM15_CH1NCFG 0
#endif
#ifdef CONFIG_STM32H7_TIM15_CH2OUT_1
#  define PWM_TIM15_CH2CFG GPIO_TIM15_CH2OUT_1
#else
#  define PWM_TIM15_CH2CFG 0
#endif

#ifdef CONFIG_STM32H7_TIM16_CH1OUT_1
#  define PWM_TIM16_CH1CFG GPIO_TIM16_CH1OUT_1
#else
#  define PWM_TIM16_CH1CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM16_CH1NOUT_1
#  define PWM_TIM16_CH1NCFG GPIO_TIM16_CH1NOUT_1
#else
#  define PWM_TIM16_CH1NCFG 0
#endif

#ifdef CONFIG_STM32H7_TIM17_CH1OUT_1
#  define PWM_TIM17_CH1CFG GPIO_TIM17_CH1OUT_1
#else
#  define PWM_TIM17_CH1CFG 0
#endif
#ifdef CONFIG_STM32H7_TIM17_CH1NOUT_1
#  define PWM_TIM17_CH1NCFG GPIO_TIM17_CH1NOUT_1
#else
